...
const ResearchReport = () => {
  ...
  if (report.length <= 0 && isLoading) {
    return (
      <Card className="p-4 max-w-[50vw] px-4 py-2 rounded-xl bg-white/60 backdrop-blur-sm border  border-black/10 border-solid ">
  ...
  return (
    <Card
      className="max-w-[90vw] xl:max-w-[70vw] relative px-4 py-6 rounded-xl border-black/10 border-solid shadow-none p-6
     bg-white/60 backdrop-blur-xl border antialiased mr-auto ml-20
    "
    >
      <div className="flex justify-end gap-2 mb-4 absolute top-1 right-4">
        <Button
          size="sm"
